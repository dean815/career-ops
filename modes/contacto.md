...
3. **Generate message** with 3-phrase framework:
   ...
   - **Phrase 2 (Proof)**: Candidate's biggest quantifiable achievement relevant for THAT role (e.g., "I built an AI agent handling 90% of customer service at my company before selling it")
